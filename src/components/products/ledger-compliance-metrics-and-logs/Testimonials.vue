					...
					<VueSlickCarousel v-bind="settings">
						<div>
							<i-card>
								...
								<hr>
								<span class="name font-weight-bold">Tarun Keswani</span>
						...
						<div>
							<i-card>
								...
								<hr>
								<span class="name font-weight-bold">Jan Unger</span>
						...
						<div>
							<i-card>
								...
								<hr>
								<span class="name font-weight-bold">Millie Cruz</span>
...
<script>
export default {
	name: 'ProductsLedgerComplianceMetricsAndLogsHowItWorks',
	data: () => ({
		settings: {
			slidesToShow: 3,
			arrows: true,
