<template>
	<PageSection id="immudb-cards-section">
		<i-container>
			<i-row>
				<i-column lg="4">
					<FeatureCard title="Immutable" image="/images/immudb/features/immutable2.svg">
				...
				<i-column lg="4">
					<FeatureCard title="Auditable" image="/images/immudb/features/auditable3.svg">
				...
				<i-column lg="4">
					<FeatureCard title="Secure" image="/images/immudb/features/secure2.svg">
						<p>Data ownership is verifiable by clients and auditors. Support for Intel SGX enclaves.</p>
						<p>Sign your data using <strong>Public-Key Cryptography</strong>. Support for Intel SGX enclaves.</p>
