                    ...
                    <VueSlickCarousel v-bind="settings">
                        ...
                        <div>
                            <i-card>
                                ...
                                <p class="quote">The tremendous flexibility and and the possibility to create your own dashboards with the metrics you want to keep one eye on it all the time across different infrastructure products from different vendors.</p>
                                <p class="quote"> Also I like the very great support from the Performance Analyzer team!</p>
                                <hr>
                                <span class="name _font-weight-bold">Jan Unger</span>
                        ...
                        <div>
                            <i-card>
                                <fa icon="quote-left" class="fa-2x _text-align-center"/>
                                <p class="quote">While looking for a suitable monitoring, analysis and troubleshooting product for our VMware vSphere infrastructure, we found Performance Analyzer. We were impressed by the flexibility and ease of deployment of the virtual appliance and the nearly instant time to value.</p>
                                <hr>
                                <span class="name _font-weight-bold">Millie Cruz</span>
                        ...
                        <div>
                            <i-card>
                                <fa icon="quote-left" class="fa-2x _text-align-center"/>
                                <p class="quote">We receive all key indicators at a glance and no longer have to gather the information in various systems.</p>
                                <hr>
                        ...
                        <div>
                            <i-card>
                                <fa icon="quote-left" class="fa-2x _text-align-center"/>
                                <p class="quote">Performance Analyzer was running in 25 minutes. Opvizor has provided us with insights into our VMware cluster performance that we have never previously had and immediately alerted us to several issues we were unaware of.</p>
                                <hr>
