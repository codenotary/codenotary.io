<template>
    <form id="_form_2_" method="POST" action="https://vchain.activehosted.com/proc.php" class="_form _form_2 _inline-form  _dark" novalidate>
        ...
        <div class="_form-content">
            ...
            <i-form-group>
                <i-button id="_form_2_submit" variant="primary" block type="submit">
                    Submit
                </i-button>
            </i-form-group>
